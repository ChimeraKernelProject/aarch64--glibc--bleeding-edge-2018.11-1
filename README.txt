aarch64--glibc--bleeding-edge-2018.11-1
...
mpc          1.0.3                       LGPL-3.0+
mpfr         3.1.6                       LGPL-3.0+
gdb          8.1.1                       GPL-2.0+, LGPL-2.0+, GPL-3.0+, LGPL-3.0+
expat        2.2.6                       MIT
...
For those who would like to reproduce the toolchain, you can just follow these steps:
    ...
    curl http://toolchains.bootlin.com/downloads/releases/toolchains/aarch64/build_fragments/aarch64--glibc--bleeding-edge-2018.11-1.defconfig > .config
    make olddefconfig
    make
